...
export default function EvaluacionSimplificadaPage() {
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 container py-10">
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Evaluador Simplificado</CardTitle>
              <CardDescription>
                Sube la hoja de vida en formato PDF para realizar la evaluación simplificada
              </CardDescription>
            </CardHeader>
            <CardContent>
