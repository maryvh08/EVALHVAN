...
version_actual= "images/Analizador Versión Actual.jpg"
version_descriptiva= "images/Analizador Versión Descriptiva.jpg"
...
def generate_report_with_background(pdf_path, position, candidate_name, background_path, chapter):
    ...
    pdfmetrics.registerFont(TTFont('CenturyGothicBold', 'fonts/Century_Gothic_Bold.ttf'))
