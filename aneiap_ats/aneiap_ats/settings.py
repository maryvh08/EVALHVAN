...
WSGI_APPLICATION = 'aneiap_ats.wsgi.application'
...
# Rutas de datos y plantillas
DATA_DIR = os.path.join(BASE_DIR, 'data')
PDF_TEMPLATES_DIR = os.path.join(BASE_DIR, 'static', 'pdf_templates')
